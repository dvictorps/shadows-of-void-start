	...
	return (
		<section className="relative flex flex-col overflow-hidden rounded-md border border-white/40 bg-black">
			...
			<button
				type="button"
				onClick={onRetreat}
				aria-label="Retreat to map"
				className="absolute right-3 top-3 z-10 inline-flex items-center gap-1.5 border border-white/40 bg-black px-3 py-1.5 text-[10px] font-medium uppercase tracking-wider text-white/80 transition hover:border-white hover:bg-white/10 hover:text-white"
			>
