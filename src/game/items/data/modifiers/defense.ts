...
export const DEFENSE_MODIFIERS: Record<string, Modifier> = {
	...
	healthFlat: {
		...
		modifierType: "flat",
		category: "defensive",
		applicableTo: ["allArmor", "allJewelry", "offhand", "quiver"],
	...
	manaFlat: {
		...
		modifierType: "flat",
		category: "defensive",
		applicableTo: ["allArmor", "allJewelry", "staff", "wand", "tome", "offhand"],
	...
	manaRegenFlat: {
		...
		modifierType: "flat",
		category: "defensive",
		applicableTo: ["allArmor", "allJewelry", "tome", "staff", "wand"],
