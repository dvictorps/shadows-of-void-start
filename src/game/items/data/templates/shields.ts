...
// Shields (offhand, plate) — Implicit: +{value}% Block Chance
export const SHIELD_TEMPLATES: EquipmentTemplate[] = [
	...
	},
	{
		...
		baseStats: { armor: 105, evasion: 52, blockChance: 22 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 128, evasion: 64, blockChance: 23 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 155, evasion: 78, blockChance: 23 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 185, evasion: 92, blockChance: 24 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 218, evasion: 109, blockChance: 24 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 255, evasion: 128, blockChance: 25 },
		implicits: [
	...
	{
		id: "shield_t8",
		name: "Damascus Shield",
		equipmentType: "offhand",
		armorType: "plate",
		dropLevel: 32,
		requirements: { level: 32, str: 58 },
		baseStats: { armor: 296, evasion: 148, blockChance: 25 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 340, evasion: 170, blockChance: 26 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 388, evasion: 194, blockChance: 26 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 440, evasion: 220, blockChance: 27 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 496, evasion: 248, blockChance: 27 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 555, evasion: 278, blockChance: 28 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 618, evasion: 309, blockChance: 28 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 685, evasion: 342, blockChance: 29 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 755, evasion: 378, blockChance: 29 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 830, evasion: 415, blockChance: 30 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 908, evasion: 454, blockChance: 30 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 990, evasion: 495, blockChance: 31 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 1075, evasion: 538, blockChance: 31 },
		implicits: [
	...
	},
	{
		...
		baseStats: { armor: 1140, evasion: 570, blockChance: 32 },
		implicits: [
